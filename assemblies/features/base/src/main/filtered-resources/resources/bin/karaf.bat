...
if %JAVA_VERSION% GTR 8 (
   set CLASSPATH=%CLASSPATH%;%KARAF_HOME%\lib\endorsed\org.apache.karaf.specs.java.xml.ws-@@project.version@@.jar;%KARAF_HOME%\lib\endorsed\org.apache.karaf.specs.locator-@@project.version@@.jar;%KARAF_HOME%\lib\endorsed\jakarta.annotation-api-@@jakarta.annotation.version@@.jar;%KARAF_HOME%\lib\endorsed\jsr305-@@jsr305.annotation.version@@.jar;%KARAF_HOME%\lib\endorsed\org.apache.servicemix.bundles.xerces-@@xerces.bundle.version@@.jar;%KARAF_HOME%\lib\endorsed\org.apache.servicemix.bundles.xalan-@@xalan.bundle.version@@.jar;%KARAF_HOME%\lib\endorsed\org.apache.servicemix.bundles.xalan-serializer-@@xalan-serializer.bundle.version@@.jar;%KARAF_HOME%\lib\endorsed\org.apache.servicemix.specs.activation-api-1.2.1-@@servicemix-spec-activation.version@@.jar;%KARAF_HOME%\lib\endorsed\validation-api-@@javax.validation.version@@.jar
