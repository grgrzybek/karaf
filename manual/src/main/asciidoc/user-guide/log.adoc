...
`org.ops4j.pax.logging.pax-logging-log4j2` bundle.
...
In the `etc/startup.properties` configuration file, you define your bundle in the list before the pax-logging-log4j2 bundle.
